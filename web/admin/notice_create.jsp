...
<head>
    ...
    <div class="page-content">
        <div class="content container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-title">发布公告 <small>Publish Notice</small></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-7">
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <form data-validate="parsley" novalidate method="post" action="${pageContext.request.contextPath}/admin/notice_create" class="form-horizontal">
                                <fieldset>
